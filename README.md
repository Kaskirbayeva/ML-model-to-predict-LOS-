...
- `data/` - example dataset for running the scripts.
- `scripts/` - R scripts for data cleaning, feature selection, model training, and result analysis.
- `figures/` - example plots generated by the analysis.
